          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Ghaziyassine/Projet-Spring-Boot-Swagger/" target="" rel="">
            ...
            <div className="body">
              <h3>Rest API</h3>
              <p>
                Building RESTful APIs using Spring Boot. This framework streamlines the development process, allowing me to create robust backend services. I can leverage Spring Data JPA for seamless database integration and utilize Swagger to generate interactive API documentation, making my APIs user-friendly and easily understandable for developers.              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://github.com/Ghaziyassine/AndroidQuizApp/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
                The project consists of an interactive and educational quiz application designed specifically for Android devices.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
